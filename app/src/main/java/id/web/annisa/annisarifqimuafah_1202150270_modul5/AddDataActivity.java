...
public class AddDataActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(AddDataActivity.this, ListActivity.class);
        //memulai intent
    ...
    public void addtodo(View view) {
        ...
        if (database.inputdata(new TambahData(editText_ToDo.getText().toString(), editText_Description.getText().toString(), editText_Priority.getText().toString()))){
            ...
            startActivity(new Intent(AddDataActivity.this, ListActivity.class));
            this.finish();
        }else {
